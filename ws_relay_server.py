...
r
You are deploying from a Blueprint for alex198000/Server2
Blueprint Name
...
render.yaml
Review Blueprint configurations from alex198000/Server2.
...
"""
WebSocket relay compatible with Unity MultiplayerNetworkManager (internet mode).
Protocol (JSON text frames):
  - First packet per connection: { "action":"Join"|"join"|... , "game_id":"ROOM", "host": true|false, "sender":"Name" }
  - Further packets are forwarded verbatim to the other peer in the same room (same game_id).
Run locally:  pip install websockets
               python ws_relay_server.py --port 7778
Render / cloud: set PORT env; bind 0.0.0.0 (default below).
"""
